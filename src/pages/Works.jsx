  ...
  return (
    <Layout>
      ...
      <div className="max-w-7xl mx-auto px-8 pt-8">
        <Breadcrumbs items={[{ name: 'Works', path: '/works' }]} />
      </div>
      ...
      <section className="py-20 px-8 bg-surface-container-low border-y border-white/5">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {techStack.map((tech, i) => (
              <span 
                key={i} 
                className="bg-white/5 hover:bg-primary/20 hover:text-primary transition-all px-6 py-2 rounded-xl text-sm font-bold border border-white/5 hover:border-primary/40 cursor-default"
              >
                {tech}
              </span>
            ))}
