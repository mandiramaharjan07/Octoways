...
export default function ProductsHero() {
  ...
  return (
    <section id="products-hero" className="relative min-h-[60vh] flex items-center px-8 pt-20 overflow-hidden bg-animated-neural transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 text-center">
        <div className="flex justify-center items-center gap-2 mb-6 reveal">
          ...
          <span className="text-secondary text-[11px] font-bold uppercase tracking-[0.3em]">Next-Generation Software Solutions</span>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 reveal delay-300">
          <button 
            ...
            className="bg-primary text-on-primary px-10 py-5 rounded-2xl font-bold text-lg hover:bg-secondary transition-all active:scale-95 shadow-lg shadow-primary/20"
          >
            Explore Products
          </button>
          <button 
            onClick={() => window.location.href = '/book-an-appointment'}
            className="px-10 py-5 rounded-2xl font-bold text-lg border border-border bg-surface-raised hover:bg-surface-card transition-all group active:scale-95 text-text-primary shadow-sm"
          >
