...
export default function ProductsGrid() {
  return (
    <section id="products-grid" className="py-24 px-8 bg-background transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {products.map((product, index) => (
            <motion.div 
              ...
              className="bg-surface-card border border-border rounded-[2.5rem] overflow-hidden group hover:bg-surface-raised transition-all duration-500 flex flex-col shadow-card hover:shadow-xl hover:border-border-accent"
            >
              <div className="aspect-[16/10] overflow-hidden relative">
                ...
                <div className="absolute top-6 left-6">
                  <span className="bg-primary text-on-primary text-[10px] font-bold px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg">
                    {product.badge}
                  </span>
                </div>
              </div>
              ...
              <div className="p-10 flex flex-col flex-grow">
                <h2 className="font-headline text-3xl font-bold mb-4 text-text-primary group-hover:text-primary transition-colors">
                  {product.name}
                </h2>
                ...
                <div className="space-y-4 mb-10 flex-grow">
                  <h3 className="text-[11px] font-bold uppercase tracking-[0.2em] text-secondary">Key Features</h3>
                ...
                <button 
                  ...
                  className="flex items-center gap-2 font-bold text-primary group/btn w-fit uppercase tracking-widest text-xs hover:text-secondary transition-colors"
                >
                  Learn More 
