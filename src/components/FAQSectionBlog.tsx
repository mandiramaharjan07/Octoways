...
const FAQSectionBlog: React.FC<FAQSectionBlogProps> = ({ 
  faqs = [], 
  title = "Frequently Asked Questions", 
  subtitle = "Everything you need to know about Octoways and our AI ecosystem." 
}) => {
  ...
  return (
    <section className="section-padding bg-background relative overflow-hidden border-t border-border" id="section-faq">
      ...
      <div className="container-tight relative z-10">
        ...
        <div className="bg-surface rounded-3xl p-6 md:p-10 shadow-card border border-border">
          {faqs.map((faq, index) => (
            <FAQItem 
              key={index}
              q={faq.q}
