    ...
    <section className="py-24 px-8 bg-background relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <motion.div 
          ...
          className="glass-panel p-10 md:p-16 rounded-[3rem] text-center shadow-card"
        >
          <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-8 shadow-sm">
          ...
          <div className="max-w-md mx-auto relative mb-4">
            <div className="flex flex-col md:flex-row gap-4">
              <input 
                className="flex-grow bg-surface-container-low rounded-2xl px-6 py-4 text-white focus:outline-none focus:ring-2 focus:ring-primary transition-all shadow-inner" 
