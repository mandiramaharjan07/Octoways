...
export default function ContactHero() {
  return (
    <section className="relative min-h-[40vh] flex items-center px-8 pt-20 overflow-hidden bg-animated-neural">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 text-center">
        <div className="flex justify-center items-center gap-2 mb-6 reveal">
          ...
          <span className="text-primary-fixed-dim text-xs font-bold uppercase tracking-[0.3em]">We're Here to Help</span>
        </div>
        ...
        <p className="text-on-surface-variant text-xl leading-relaxed max-w-3xl mx-auto reveal delay-200">
